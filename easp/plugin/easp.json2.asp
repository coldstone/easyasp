...
Class EasyAsp_Json2
	...
	'建新实例
	Public Function [New]()
		Set [New] = New EasyAsp_Json2
	End Function
	Public Default Function Parse(ByVal v)
		Set Parse = ScriptControl.CodeObject.JSON.parse(v)
	End Function
